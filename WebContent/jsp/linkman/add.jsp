...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/linkMan_saveLinkMan"
		method=post>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan="3">
									<s:select name="customer.cust_id" list="customerList" headerKey="" headerValue="--请选择--" listKey="cust_id" listValue="cust_name">
									</s:select>
								</td>
							</tr>
							<TR>
								<td>联系人名称：</td>
								<td>
								<s:textfield cssClass="textbox" id="sChannel2" name="lkm_name" cssStyle="WIDTH: 180px" maxLength="50"/>
								</td>
								<td>联系人性别：</td>
								<td>
							...
							<TR>
								<td>爱好 ：</td>
								<td colspan="3">
								<s:checkboxlist name="lkm_hobby" list="{'eat','sleep','work' }"></s:checkboxlist>
								</td>
