										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>拜访时间：</TD>
													<TD>
													<s:textfield cssClass="textbox" id="visit_time" name="visit_time" value="%{#pagination.parameterMap.visit_time[0]}" cssStyle="WIDTH: 80px" maxLength="50" readonly="true"></s:textfield>
													</TD>
													<TD>至</TD>
													<TD>
													<s:textfield cssClass="textbox" id="visit_end_time" name="visit_end_time" value="%{#pagination.parameterMap.visit_end_time[0]}" cssStyle="WIDTH: 80px" maxLength="50" readonly="true"></s:textfield>
													</TD>
