										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>客户名称：</TD>
													<TD>
													<s:textfield cssClass="textbox" id="sChannel2" cssStyle="WIDTH: 80px" maxLength="50" name="cust_name" />
													</TD>
													<TD>客户电话：</TD>
													<TD>
													<s:textfield cssClass="textbox" id="sChannel2" cssStyle="WIDTH: 80px" maxLength="50" name="cust_mobile"/>
													</TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/customer_showCustomer?cust_id=${cust_id}">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/customer_deleteCustomer?cust_id=${cust_id}" class="delLine">删除</a>
													</TD>
												</TR>
												</s:iterator>
