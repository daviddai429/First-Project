								...
								<TR>
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="${pageContext.request.contextPath }/customer_add.action" 
									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
													<s:a cssClass="style2" action="linkMan_showAdd" namespace="/" target="main">－ 新增联系人</s:a>
													</TD>
												</TR>
												<TR>
													<TD class=menuSmall>
													<s:a cssClass="style2" action="linkMan_showLinkMan" namespace="/" target="main">－ 联系人列表</s:a>
													</TD>
												</TR>
									...
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall> 
													<s:a cssClass="style2" action="saleVisit_showAdd" target="main">－新增客户拜访</s:a>
														</TD>
												</TR>
												<TR>
													<TD class=menuSmall>
													<s:a cssClass="style2" action="saleVisit_findAll" target="main">－客户拜访列表</s:a>
													</TD>
												</TR>
